...
const ItemOptions = class {
  ...
  render() {
    const mode = (0,_ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    const isEnd = (0,_helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.l)(this.side);
    return (0,_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      class: {
        [mode]: true,
...
const ItemSliding = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_ferro_Desktop_FYF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-f49d994d.js */ 80271))).createGesture({
        el: _this2.el,
  ...
  updateOptions() {
    ...
    return (0,_Users_ferro_Desktop_FYF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        const option = yield options.item(i).componentOnReady();
        const side = (0,_helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.l)(option.side) ? 'end' : 'start';
