(function () {
  ...
  (self["webpackChunkfind_you_future_app"] = self["webpackChunkfind_you_future_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"], {
    ...
    71855: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      60504); // Defaults for the card swipe animation
      ...
      var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
        ...
        var onMove = function onMove(detail) {
          var step = (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_2__.h)(0.0001, detail.deltaY / height, 0.9999);
        ...
        var gesture = (0, _index_f49d994d_js__WEBPACK_IMPORTED_MODULE_7__.createGesture)({
          el: el,
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
        var backdropAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
          'pointer-events': 'none'
        }).afterClearStyles(['pointer-events']);
        var wrapperAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        var baseAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().afterStyles({
                'transform': _finalTransform
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
        ...
        var backdropAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
        var wrapperAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        var baseAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
      ...
      var mdEnterAnimation = function mdEnterAnimation(baseEl) {
        var baseAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)();
        var backdropAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)();
        var wrapperAnimation = (0, _animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_3__.c)();
      ...
      var Modal = /*#__PURE__*/function () {
        function Modal(hostRef) {
          ...
          this.didDismiss = (0, _index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionModalDidDismiss", 7); // Whether or not modal is being dismissed via gesture
        ...
        _createClass(Modal, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      _context.next = 8;
                      return (0, _framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_11__.a)(this.delegate, container, this.component, ['ion-page'], componentProps);

                    case 8:
                      this.usersElement = _context.sent;
                      _context.next = 11;
                      return (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.usersElement);
                    ...
                    case 11:
                      ...
                      _context.next = 14;
                      return (0, _overlays_12c20431_js__WEBPACK_IMPORTED_MODULE_9__.d)(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      _context3.next = 5;
                      return (0, _overlays_12c20431_js__WEBPACK_IMPORTED_MODULE_9__.f)(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
                    ...
                    case 5:
                      ...
                      _context3.next = 9;
                      return (0, _framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_11__.d)(this.delegate, this.usersElement);
          ...
          value: function render() {
            ...
            return (0, _index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "aria-modal": "true",
              tabindex: "-1",
              "class": Object.assign((_Object$assign = {}, _defineProperty(_Object$assign, mode, true), _defineProperty(_Object$assign, "modal-card", this.presentingElement !== undefined && mode === 'ios'), _Object$assign), (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_10__.g)(this.cssClass)),
              style: {
            ...
            }, (0, _index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", {
              visible: this.showBackdrop,
              tappable: this.backdropDismiss
            }), mode === 'ios' && (0, _index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "modal-shadow"
