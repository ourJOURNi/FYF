...
const Segment = class {
  ...
  addRipple(detail) {
    const useRippleEffect = _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('animated', true) && _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('rippleEffect', true);
    ...
    const {
      x,
      y
    } = (0,_helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.p)(detail.event);
