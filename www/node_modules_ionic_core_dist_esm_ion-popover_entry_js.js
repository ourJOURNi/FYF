...
/* harmony import */ var _framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./framework-delegate-4584ab5a.js */ 98582);
...
const mdEnterAnimation = (baseEl, ev) => {
  ...
  const backdropAnimation = (0,_animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const wrapperAnimation = (0,_animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const contentAnimation = (0,_animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const viewportAnimation = (0,_animation_54fe0237_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  backdropAnimation.addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  wrapperAnimation.addElement(baseEl.querySelector('.popover-wrapper')).fromTo('opacity', 0.01, 1);
...
const Popover = class {
  ...
  present() {
    ...
    return (0,_Users_ferro_Desktop_FYF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.usersElement = yield (0,_framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_9__.a)(_this.delegate, container, _this.component, ['popover-viewport', _this.el['s-sc']], data);
      yield (0,_index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_5__.e)(_this.usersElement);
      return (0,_overlays_12c20431_js__WEBPACK_IMPORTED_MODULE_7__.d)(_this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, _this.event);
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_ferro_Desktop_FYF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const shouldDismiss = yield (0,_overlays_12c20431_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this2.event);

      if (shouldDismiss) {
        yield (0,_framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_9__.d)(_this2.delegate, _this2.usersElement);
      }
  ...
  render() {
    ...
    return (0,_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      class: Object.assign(Object.assign({}, (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.cssClass)), {
        [mode]: true,
