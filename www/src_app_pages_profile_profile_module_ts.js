...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_modals_image-cropper_image-cropper_module_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_profile_change-profile-picture_change-profile-picture_change-profile-picture_mo-9a34fe")]).then(__webpack_require__.bind(__webpack_require__, /*! ./change-profile-picture/change-profile-picture/change-profile-picture.module */ 90416)).then(m => m.ChangeProfilePicturePageModule)
    },
    {
        path: 'resume',
    ...
    {
        path: 'view-resume',
        loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./resume/view-resume/view-resume.module */ 47659)).then(m => m.ViewResumePageModule)
    },
    {
        path: 'update-resume',
...
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic/storage */ 37045);
...
ProfilePage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    ...
    (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__metadata)("design:paramtypes", [typeof (_a = typeof _services_auth_service__WEBPACK_IMPORTED_MODULE_2__.AuthService !== "undefined" && _services_auth_service__WEBPACK_IMPORTED_MODULE_2__.AuthService) === "function" ? _a : Object, typeof (_b = typeof _services_profile_service__WEBPACK_IMPORTED_MODULE_3__.ProfileService !== "undefined" && _services_profile_service__WEBPACK_IMPORTED_MODULE_3__.ProfileService) === "function" ? _b : Object, typeof (_c = typeof _ionic_storage__WEBPACK_IMPORTED_MODULE_7__.Storage !== "undefined" && _ionic_storage__WEBPACK_IMPORTED_MODULE_7__.Storage) === "function" ? _c : Object, typeof (_d = typeof _angular_router__WEBPACK_IMPORTED_MODULE_5__.Router !== "undefined" && _angular_router__WEBPACK_IMPORTED_MODULE_5__.Router) === "function" ? _d : Object, typeof (_e = typeof _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.ToastController !== "undefined" && _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.ToastController) === "function" ? _e : Object, typeof (_f = typeof _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.AlertController !== "undefined" && _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.AlertController) === "function" ? _f : Object, typeof (_g = typeof _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.LoadingController !== "undefined" && _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.LoadingController) === "function" ? _g : Object])
], ProfilePage);
...
module.exports = ".profile-wrapper {\n  margin: 16px auto;\n}\n\n@media only screen and (max-width: 575px) {\n  .profile-wrapper {\n    margin: 24px auto;\n  }\n}\n\nion-alert {\n  --background: #e4405f;\n}\n\nion-list {\n  background: none;\n}\n\nion-item {\n  background: none;\n  --color: #0055a5;\n  margin: 8px auto;\n  box-shadow: 1px 10px 26px rgba(0, 0, 0, 0.05);\n  border-radius: 5px;\n}\n\n.desktop-toolbar {\n  --background: none;\n  padding-bottom: 16px;\n  border-bottom: 1px solid rgba(51, 51, 51, 0.1490196078);\n}\n\n.desktop-toolbar h1 {\n  color: #0055a5;\n}\n\n#profile-info {\n  height: auto;\n}\n\n#logout-item {\n  --background: none;\n  --color: #e3405f;\n  font-weight: 600;\n  --border-color: #e3405f;\n  --border-style: solid;\n  --border-width: 2px;\n  margin-bottom: 100px;\n}\n\nh4 {\n  color: #000;\n  font-size: 1.9em;\n  opacity: 1;\n}\n\np {\n  font-size: 1em;\n  opacity: 1;\n  transition: 0.5s;\n}\n\nspan {\n  color: #0055a5;\n  font-weight: 600;\n  width: 64px;\n  display: inline-block;\n}\n\n#profile-picture {\n  height: 100px;\n  width: 100px;\n  border-radius: 100px;\n  margin: 0 auto 8px;\n  display: block;\n  opacity: 1;\n}\n\n.back-button {\n  opacity: 1;\n}\n\n.blue-button {\n  --background: #0055a5;\n  opacity: 1;\n  height: 24px;\n  width: 100px;\n  font-size: 0.5em;\n}\n\n.logout-button {\n  color: white;\n  --background: #e4405f;\n  --background-hover: #dd3252;\n  height: 24px;\n  width: 100px;\n  font-size: 0.5em;\n  font-weight: 600;\n  box-shadow: 1px 1px 10px rgba(0, 0, 0, 0.1);\n  margin-bottom: 52px auto;\n}\n\n@keyframes text-slide-up {\n  0% {\n    transform: translateY(20px);\n  }\n  100% {\n    opacity: 1;\n    transform: translateY(0px);\n  }\n}\n\n@keyframes pic-slide-right {\n  0% {\n    transform: translateX(-20px);\n  }\n  100% {\n    opacity: 1;\n    transform: translateX(0px);\n  }\n}\n\n@keyframes header-slide-right {\n  0% {\n    transform: translateX(-20px);\n  }\n  100% {\n    opacity: 1;\n    transform: translateX(0px);\n  }\n}\n\n@keyframes buttons-slide-up {\n  0% {\n    transform: translateY(-20px);\n  }\n  100% {\n    opacity: 1;\n    transform: translateY(0px);\n  }\n}\n\n@keyframes buttons-slide-right {\n  0% {\n    transform: translateX(-20px);\n  }\n  100% {\n    opacity: 1;\n    transform: translateX(0px);\n  }\n}\n\n@media screen and (max-width: 992px) {\n  p {\n    font-size: 1em;\n  }\n  span {\n    color: #0055a5;\n    font-weight: 600;\n    width: 64px;\n    display: inline-block;\n    text-align: left;\n    margin-right: 10px;\n  }\n}\n\n@media screen and (min-width: 768px) {\n  #change-pro-pic-button {\n    position: absolute;\n    top: 75px;\n    left: 188px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
