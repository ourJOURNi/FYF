(function () {
  ...
  (self["webpackChunkfind_you_future_app"] = self["webpackChunkfind_you_future_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-nav_2_entry_js"], {
    /***/
    16735:
    /*!**************************************************************!*\
      ...
      var ViewController = /*#__PURE__*/function () {
        ...
        _createClass(ViewController, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 5;
                      return (0, _framework_delegate_4584ab5a_js__WEBPACK_IMPORTED_MODULE_6__.a)(_this.delegate, container, component, ['ion-page', 'ion-page-invisible'], _this.params);
          ...
          value: function _destroy() {
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
        ...
        _createClass(Nav, [{
          ...
          value: function componentWillLoad() {
            ...
            if (this.swipeGesture === undefined) {
              ...
              this.swipeGesture = _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('swipeBackEnabled', mode === 'ios');
            }
          ...
          value: function disconnectedCallback() {
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.d);
              ...
              viewIsReady: function viewIsReady(enteringEl) {
                ...
                resolve({
                  ...
                  markVisible: function () {
                    var _ref = (0, _Users_ferro_Desktop_United_Way_FYF_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
          ...
          value: function prepareTI(ti) {
            ...
            if (ti.removeView !== undefined) {
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(ti.removeStart !== undefined, 'removeView needs removeStart');
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(ti.removeCount !== undefined, 'removeView needs removeCount');
            ...
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(insertViews.length > 0, 'length can not be zero');
          ...
          value: function postViewInit(enteringView, leavingView, ti) {
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(leavingView || enteringView, 'Both leavingView and enteringView are null');
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(ti.resolve, 'resolve must be valid');
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(ti.reject, 'reject must be valid');
            var opts = ti.opts;
            var insertViews = ti.insertViews;
            var removeStart = ti.removeStart;
            ...
            if (removeStart !== undefined && removeCount !== undefined) {
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(removeStart >= 0, 'removeStart can not be negative');
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(removeCount >= 0, 'removeCount can not be negative');
              destroyQueue = [];
            ...
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(finalBalance >= 0, 'final balance can not be negative');
            ...
            if (destroyQueue && destroyQueue.length > 0) {
              ...
              try {
                for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                  ...
                  (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.l)(_view2.element, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.b);
                  (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.l)(_view2.element, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.c);
                  (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.l)(_view2.element, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.d);
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      ...
                      mode = (0, _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this6);
                      ...
                      animationOpts = Object.assign({
                        ...
                        baseEl: _this6.el,
                        animationBuilder: _this6.animation || opts.animationBuilder || _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.c.get('navAnimation'),
                        progressCallback: progressCallback,
                        animated: _this6.animated && _ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('animated', true),
                        enteringEl: enteringEl,
                        leavingEl: leavingEl
                      }, opts);
                      _context7.next = 8;
                      return (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.t)(animationOpts);
          ...
          value: function insertViewAt(view, index) {
            ...
            if (existingIndex > -1) {
              ...
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(view.nav === this, 'view is not part of the nav');
              views.splice(index, 0, views.splice(existingIndex, 1)[0]);
            } else {
              (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(!view.nav, 'nav is used'); // this is a new view to add to the stack
          ...
          value: function removeView(view) {
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
            var views = this.views;
            var index = views.indexOf(view);
            (0, _helpers_90f46169_js__WEBPACK_IMPORTED_MODULE_3__.k)(index > -1, 'view must be part of the stack');
            ...
            for (var i = views.length - 1; i >= 0; i--) {
              ...
              if (element) {
                if (i > activeViewIndex) {
                  ...
                  // let's unload it
                  (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.l)(element, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.d);
                  this.destroyView(view);
                } else if (i < activeViewIndex) {
                  // this view comes before the active view
                  // and it is not a portal then ensure it is hidden
                  (0, _index_1eeeab2e_js__WEBPACK_IMPORTED_MODULE_4__.s)(element, true);
                }
              }
            }
          }
          ...
          value: function onEnd(shouldComplete, stepValue, dur) {
            ...
            if (this.sbAni) {
              ...
              if (!shouldComplete) {
                ...
                newStepValue += (0, _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_5__.g)([0, 0], [1, 0], [0.68, 0.28], [1, 1], stepValue)[0];
              } else {
                newStepValue += (0, _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_5__.g)([0, 0], [0.32, 0.72], [0, 1], [1, 1], stepValue)[0];
              }
