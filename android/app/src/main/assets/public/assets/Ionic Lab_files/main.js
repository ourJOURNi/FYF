...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-landing-landing-module */ "pages-auth-landing-landing-module").then(__webpack_require__.bind(null, /*! ./pages/auth/landing/landing.module */ "./src/app/pages/auth/landing/landing.module.ts")).then(m => m.LandingPageModule)
    ...
    {
        path: 'personal-info',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-sign-up-personal-info-personal-info-module */ "pages-auth-sign-up-personal-info-personal-info-module").then(__webpack_require__.bind(null, /*! ./pages/auth/sign-up/personal-info/personal-info.module */ "./src/app/pages/auth/sign-up/personal-info/personal-info.module.ts")).then(m => m.PersonalInfoPageModule)
    },
    //  change to forgot password path name later
    {
        path: 'enter-email',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-forgot-password-enter-email-enter-email-module */ "pages-auth-forgot-password-enter-email-enter-email-module").then(__webpack_require__.bind(null, /*! ./pages/auth/forgot-password/enter-email/enter-email.module */ "./src/app/pages/auth/forgot-password/enter-email/enter-email.module.ts")).then(m => m.EnterEmailPageModule)
    },
    {
        path: 'enter-code',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-auth-forgot-password-enter-code-enter-code-module */ "forgot-password-enter-code-enter-code-module").then(__webpack_require__.bind(null, /*! ./pages/auth/forgot-password/enter-code/enter-code.module */ "./src/app/pages/auth/forgot-password/enter-code/enter-code.module.ts")).then(m => m.EnterCodePageModule)
    },
    {
        path: 'events',
...
__webpack_require__(/*! /Users/ferro/Desktop/Apps & Websites/United-Way/Mobile/node_modules/webpack-dev-server/client/index.js?http://0.0.0.0:0/sockjs-node&sockPath=/sockjs-node */"./node_modules/webpack-dev-server/client/index.js?http://0.0.0.0:0/sockjs-node&sockPath=/sockjs-node");
module.exports = __webpack_require__(/*! /Users/ferro/Desktop/Apps & Websites/United-Way/Mobile/src/main.ts */"./src/main.ts");
